<?php 
    ...
    if (isset($_REQUEST['delete_id'])) {
        ...
        $delete_stmt = $db->prepare('DELETE FROM purchase WHERE id = :id');
        ...
        <div class="container-fluid shadow">
            <div class="container ">
                <nav class="navbar navbar-expand-lg navbar-light bg-transparent ">
                    <a class="navbar-brand" href="#" style="font-size: 28px;"><img
                            src="img/palmy logo admin.png" alt="" style="width: 140px;" class="me-3"></a>
                    ...
                    <div class="collapse navbar-collapse " id="navbarNavDropdown">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item" style="margin-right: 30px;"> 
                                <a href="register.php"        
                                 class="text-decoration-none" style="color: gray;">เพิ่มสมาชิก</a>
                             </li>
                            
                          <form action="" method="POST"><button type="submit" name="logout" class="btn btn-outline-primary">Logout</button></form>
        ...
        <div class="container p-4 shadow  mt-4">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-result-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-result" type="button" role="tab" aria-controls="pills-result"
                        aria-selected="true">Manage knowledge base
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-form-tab" data-bs-toggle="pill" data-bs-target="#pills-form"
                        type="button" role="tab" aria-controls="pills-form" aria-selected="false">Manage Purchase form
                    </button>
                </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-result" role="tabpanel"
                    ...
                    <div style=" height: 400px; width: 500px;">
                        <div style="border: solid;position: relative; height: 350px;width: 100%;border: 2px dashed #0d6efd;border-radius: 10px;display: flex;align-items: center;justify-content: center;overflow: hidden;" class="wrapper mt-3 mb-3">
			...
			$('#imageUpload').change(function () {
                ...
                <!-- <div class="bartext1 d-flex justify-content-between">
                            ...
                            <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar"
                                    style="width: 20%; background-color:#000000;" aria-valuenow="20" aria-valuemin="0"
                                    aria-valuemax="100">
                                    F</div>
                                <div class="progress-bar " role="progressbar"
                                    ...
                                    D</div>
                                <div class="progress-bar" role="progressbar"
                                    style="width: 20%; background-color:#3e0001;" aria-valuenow="20" aria-valuemin="0"
                                    aria-valuemax="100">C</div>
                                <div class="progress-bar" role="progressbar"
                                    style="width: 20%; background-color:#7c0000;" aria-valuenow="20" aria-valuemin="0"
                                    aria-valuemax="100">B</div>
                                <div class="progress-bar" role="progressbar"
                                    style="width: 20%; background-color:#ba0001;" aria-valuenow="20" aria-valuemin="0"
                                    aria-valuemax="100">A</div>
                            </div>
                            ...
                            <div class="progress" style="height: 25px;">
                                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar"
                                    style="width: 15.05%;" aria-valuenow="15.05" aria-valuemin="0" aria-valuemax="100">
                                    15.05%</div>
                            </div>-->
                            <center>
